 /*   var config1 = liquidFillGaugeDefaultSettings();
	...
	config1.waveCount = 3;
	var gauge1 = loadLiquidFillGauge("fillgauge1", 12, config1);*/
	...
	config2.waveCount = 3;
	var gauge2= loadLiquidFillGauge("fillgauge2", 12, config2);
	...
	config3.waveCount = 3;
	var gauge3 = loadLiquidFillGauge("fillgauge3", 8, config3);
	...
	config4.waveCount = 3;
	var gauge4 = loadLiquidFillGauge("fillgauge4", 5, config4);
	...
	config5.waveCount = 3;
	var gauge5 = loadLiquidFillGauge("fillgauge5", 1.5, config5);
